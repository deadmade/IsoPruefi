...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            var tempGen = new TempSensorReading { Timestamp = timestamp, Value = value, Sequence = sequenceOne++, Meta = {}};
    ...
    ""meta"": 
        {
            ...
            tempGen = new TempSensorReading { Timestamp = timestamp, Value = value, Sequence = sequenceTwo++, Meta = {} };
